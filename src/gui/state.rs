...
pub struct App {
    ...
    pub vhs_rescue_deinterlace: bool,
    pub vhs_rescue_stabilize: bool,
    pub vhs_rescue_denoise_type: String,
    pub vhs_rescue_sharpen: bool,
    pub vhs_rescue_color: bool,
    pub vhs_rescue_highpass: String,
    pub vhs_rescue_lowpass: String,
    pub vhs_rescue_compressor: bool,
    pub vhs_rescue_gate: bool,
    pub vhs_rescue_normalize: bool,
...
impl Default for App {
    ...
    fn default() -> Self {
        App {
            ...
            vhs_rescue_notch: "60".to_string(), // Default per il preset VHS
            vhs_rescue_deinterlace: true,
            vhs_rescue_stabilize: true,
            vhs_rescue_denoise_type: "hqdn3d".to_string(),
            vhs_rescue_sharpen: true,
            vhs_rescue_color: true,
            vhs_rescue_highpass: "80".to_string(),
            vhs_rescue_lowpass: "15k".to_string(), // Valore suggerito per il preset
            vhs_rescue_compressor: true,
            vhs_rescue_gate: true,
            vhs_rescue_normalize: true,
