    ...
    column![
        ...
        row![
            text_input(translate("input_file_placeholder"), input)
                ...
                .padding(10),
            button(translate("browse_button")).on_press(Message::EnhanceAudioBrowseInput),
        ]
        .spacing(10),
        row![
            text_input(translate("output_file_placeholder"), output)
                ...
                .padding(10),
            button(translate("browse_button")).on_press(Message::EnhanceAudioBrowseOutput),
        ]
        .spacing(10),
        ...
        button(translate("start_audio_enhancement_button")).on_press(Message::EnhanceAudioButtonPressed),
    ]
